...
if __name__ == "__main__":
    ...
    wsLogin = websocket.WebSocketApp("ws://www.roboticrover.com:5000/rover/login",
                                     on_open=on_login_open,
                                     on_message=on_login_message,
                                     on_error=on_login_error,
                                     on_close=on_login_close)

    wsCoords = websocket.WebSocketApp("ws://www.roboticrover.com:5000/rover/coords",
                                      on_open=on_coords_open,
                                      on_message=on_coords_message,
                                      on_error=on_coords_error,
                                      on_close=on_coords_close)

    wsHeartBeat = websocket.WebSocketApp("ws://www.roboticrover.com:5000/rover/heartbeat",
